...
class CreateCommentsTable extends Migration
{
    ...
    public function down()
    {
        ...
        if (method_exists(Schema::class, 'dropColumns')) {
            Schema::dropColumns('winter_blog_posts', ['ratmd_bloghub_comment_mode', 'ratmd_bloghub_comment_visible']);
        } else {
            Schema::table('winter_blog_posts', function (Blueprint $table) {
                if (Schema::hasColumn('winter_blog_posts', 'ratmd_bloghub_comment_mode')) {
                    $table->dropColumn('ratmd_bloghub_comment_mode');
                }
            });
            Schema::table('winter_blog_posts', function (Blueprint $table) {
                if (Schema::hasColumn('winter_blog_posts', 'ratmd_bloghub_comment_visible')) {
